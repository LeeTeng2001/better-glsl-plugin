...
public class GlslMemberAccessHeadImpl extends ASTWrapperPsiElement implements GlslMemberAccessHead {

  public GlslMemberAccessHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GlslVisitor visitor) {
    visitor.visitMemberAccessHead(this);
  }
